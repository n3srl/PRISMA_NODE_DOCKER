...
class GroupHasPersonFactoryBase {
    ...
    public static function Save($object) {
        ...
        $query = "INSERT INTO core_group_has_person 
        (id,oid,person_id,group_id,modified_by,created_by,assigned,
        create_date,valid_from,valid_to,erased,last_update) 
        VALUES 
        ( null,$ob->oid,$ob->person_id,$ob->group_id,$ob->modified_by,$ob->created_by,
        $ob->assigned,$ob->create_date,$ob->valid_from,$ob->valid_to,0,now())";
