<?php
/**
 * Class for ContactFactoryBase
 * 
 * @author: N3 S.r.l.
 */
class ContactFactoryBase
{
	public static function Save( $object )
	{
		global $db_conn;
		$ob = clone $object;
        ContactFactory::CheckData( $ob );
		ContactFactoryBase::CleanData( $ob );
		
		$query = "INSERT INTO core_person 
        (oid,email,title,first_name,middle_name,last_name,suffix,
        ...
        VALUES ($ob->oid,$ob->email,$ob->title,$ob->first_name,
	...
	{
		global $db_conn;
		//ContactFactoryBase::cleanData( $object );
		ContactFactory::CheckData( $object );
		$query = "UPDATE core_person SET 
