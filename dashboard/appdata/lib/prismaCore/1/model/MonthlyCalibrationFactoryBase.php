<?php
/**
 * Class for MonthlyCalibration
 * 
 * Questa classe è stata creata solamente per separare le calibrazioni mensili dalle calibrazioni generali. 
 * Le calibrazioni mensili NON necessitano di operazioni di salvataggio, aggiornamento o cancellazione.
 * 
 * @author: N3 S.r.l.
 */
class MonthlyCalibrationFactoryBase
{
	...
	{
		global $db_conn;
		$query = "SELECT * FROM pr_drv_monthly_calibration WHERE name LIKE '%$name%'";
		$res = @mysqli_query($db_conn,$query);
