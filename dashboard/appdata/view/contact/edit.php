        ...
        <div class='row'>
            <div class='col-md-12 col-sm-12 col-xs-12'>
                <div id='list' class='x_panel'>
                    <div class='x_title no-padding-lr'>
                        <div class='clearfix'>
                            ...
                            <div class='col-md-6 no-padding'>
                                <a href='#edit'><button type='button' onclick='newObj()' style='margin-right: 10px' class='btn btn-success pull-right'><?= _('AGGIUNGI NUOVO CONTATTO') ?></button></a>
                            </div>
                        </div>
                    </div>
                    <div style="display: none" class='x_panel filter-container'>
                        ...
                        <div class='x_content filter-content' hidden>
                            ...
                            <div class='form-group col-md-3 col-sm-6 col-xs-12 93c731f1c3a84ef05cd54d044c379eaa'>
                                <div class='form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('company')) ?></small>
                                        <select class='form-control filter filter-text' id='F_company' multiple='multiple' title='<?php echo (_('Filtra per compagnia/associazione')) ?>'>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class='form-group col-md-3 col-sm-6 col-xs-12 f7a42fe7211f98ac7a60a285ac3a9e87'>
                                <div class='form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('phone')) ?></small>
                                        <select class='form-control filter filter-text' id='F_phone' multiple='multiple' title='<?php echo (_('Filtra per telefono')) ?>'>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class='form-group col-md-3 col-sm-6 col-xs-12 884d9804999fc47a3c2694e49ad2536a'>
                                <div class='form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('address')) ?></small>
                                        <select class='form-control filter filter-text' id='F_address' multiple='multiple' title='<?php echo (_('Filtra per indirizzo')) ?>'>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class='form-group col-md-3 col-sm-6 col-xs-12 e90ebd9556fa4031171f043013794b61'>
                                <div class='form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('postcode')) ?></small>
                                        <select class='form-control filter filter-text' id='F_postcode' multiple='multiple' title='<?php echo (_('Filtra per cap')) ?>'>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class='form-group col-md-3 col-sm-6 col-xs-12 4ed5d2eaed1a1fadcc41ad1d58ed603e'>
                                <div class='form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('city')) ?></small>
                                        <select class='form-control filter filter-text' id='F_city' multiple='multiple' title='<?php echo (_('Filtra per città')) ?>'>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class='form-group col-md-3 col-sm-6 col-xs-12 53aad639aca4b5c010927cf610c3ff9c'>
                                <div class='form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('province')) ?></small>
                                        <select class='form-control filter filter-text' id='F_province' multiple='multiple' title='<?php echo (_('Filtra per provincia')) ?>'>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class='form-group col-md-3 col-sm-6 col-xs-12 e909c2d7067ea37437cf97fe11d91bd0'>
                                <div class='form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('country')) ?></small>
                                        <select class='form-control filter filter-text' id='F_country' multiple='multiple' title='<?php echo (_('Filtra per nazione')) ?>'>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class='col-md-3 col-sm-6 col-xs-12 55b9fb22d536d87ffa157e5407447e5d' hidden>
                                <div class='form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('is_station_referer')) ?></small>
                                        <select class='form-control filter filter-checkbox' id='F_is_station_referer' title='<?php echo (_('Filtra per is_station_referer')) ?>'>
                                            <option value=''></option>
                            ...
                            <div class='col-md-3 col-sm-6 col-xs-12 1b2a31ade2f7767e2525797735a21b61' hidden>
                                <div class='form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('is_administrator')) ?></small>
                                        <select class='form-control filter filter-checkbox' id='F_is_administrator' title='<?php echo (_('Filtra per is_administrator')) ?>'>
                                            <option value=''></option>
                                            <option value='1'> <?php echo (_('Sì')) ?></option>
                                            <option value='0'> <?php echo (_('No')) ?></option>
                                        </select>
                    ...
                    <div class='x_content'>
                        <table id='ContactList' class='table table-striped table-bordered' style='width: 100%; '>
                            <thead>
                                <tr>
                        ...
                        <div class='x_content'>
                            ...
                            <div class='col-md-3 col-sm-6 col-xs-12 2a034e9d9e2601c21191cca53760eaaf'>
                                <div class='item form-group'>
                                    <div class='col-xs-12'>
                                        ...
                                        <input type='text' name='first_name' class='form-control col-md-7 col-xs-12 input-disabled' placeholder=' <?php echo (_('first name')) ?> ' title=' <?php echo (_('Nome')) ?>' maxlength='100' />
                                    </div>
                                </div>
                            </div>
                            <div class='col-md-3 col-sm-6 col-xs-12 e2e657fbf2b8662e5c235b568646a061' hidden>
                                <div class='item form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('Secondo nome')) ?> </small>
                                        <input type='text' name='middle_name' class='form-control col-md-7 col-xs-12 input-disabled' placeholder=' <?php echo (_('middle name')) ?> ' title=' <?php echo (_('Secondo Nome')) ?>' maxlength='100' />
                                    </div>
                                </div>
                            </div>
                            <div class='col-md-3 col-sm-6 col-xs-12 7d4553c09a59578c8addc8c617a76ca1'>
                                <div class='item form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('Last name')) ?> </small>
                                        <input type='text' name='last_name' class='form-control col-md-7 col-xs-12 input-disabled' placeholder=' <?php echo (_('last name')) ?> ' title=' <?php echo (_('Cognome')) ?>' maxlength='100' />
                                    </div>
                                </div>
                            </div>
                            <div class='col-md-3 col-sm-6 col-xs-12 f7a42fe7211f98ac7a60a285ac3a9e87'>
                                <div class='item form-group'>
                                    <div class='col-xs-12'>
                                        ...
                                        <input type='text' name='company' class='form-control col-md-7 col-xs-12 input-disabled' placeholder=' <?php echo (_('name of company/association')) ?> ' title=' <?php echo (_('phone')) ?>' maxlength='45' />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class='col-md-3 col-sm-6 col-xs-12 884d9804999fc47a3c2694e49ad2536a'>
                                <div class='item form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('Address')) ?> </small>
                                        <input type='text' name='addressPerson' class='form-control col-md-7 col-xs-12 input-disabled' placeholder=' <?php echo (_('address')) ?> ' title=' <?php echo (_('address')) ?>' maxlength='200' />
                                    </div>
                                </div>
                            </div>
                            <div class='col-md-3 col-sm-6 col-xs-12 e90ebd9556fa4031171f043013794b61'>
                                <div class='item form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('Postcode')) ?> </small>
                                        <input type='text' name='postcodePerson' class='form-control col-md-7 col-xs-12 input-disabled' placeholder=' <?php echo (_('postcode')) ?> ' title=' <?php echo (_('postcode')) ?>' maxlength='45' />
                                    </div>
                                </div>
                            </div>
                            <div class='col-md-3 col-sm-6 col-xs-12 4ed5d2eaed1a1fadcc41ad1d58ed603e'>
                                <div class='item form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('City')) ?> </small>
                                        <input type='text' name='cityPerson' class='form-control col-md-7 col-xs-12 input-disabled' placeholder=' <?php echo (_('city')) ?> ' title=' <?php echo (_('city')) ?>' maxlength='45' />
                                    </div>
                                </div>
                            </div>
                            <div class='col-md-3 col-sm-6 col-xs-12 53aad639aca4b5c010927cf610c3ff9c'>
                                <div class='item form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('Province')) ?> </small>
                                        <input type='text' name='provincePerson' class='form-control col-md-7 col-xs-12 input-disabled to-upper' placeholder=' <?php echo (_('province')) ?> ' title=' <?php echo (_('province')) ?>' maxlength='100' />
                                    </div>
                                </div>
                            </div>
                            <div class='col-md-3 col-sm-6 col-xs-12 e909c2d7067ea37437cf97fe11d91bd0'>
                                <div class='item form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo (_('Country')) ?> </small>
                                        <input type='text' name='countryPerson' class='form-control col-md-7 col-xs-12 input-disabled to-upper' placeholder=' <?php echo (_('country')) ?> ' title=' <?php echo (_('country')) ?>' maxlength='100' />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class='col-md-3 col-sm-6 col-xs-12 55b9fb22d536d87ffa157e5407447e5d' hidden>
                                <div class='item form-group'>
                                    <div class='col-xs-12'>
                                        <label class='text-muted checkbox-label'><?php echo (_('is_station_referer')) ?></label>
                                        <!-- <input type='hidden' value='1' name='is_station_referer' class='col-md-1 col-xs-1 checkbox input-disabled' placeholder='<?php echo (_('is_station_referer')) ?>' title='<?php echo (_('is_station_referer')) ?>'> -->
                                        <input type='checkbox' id="is_station_referer" name='is_station_referer' class='col-md-1 col-xs-1 checkbox input-disabled' placeholder='<?php echo (_('is_station_referer')) ?>' title='<?php echo (_('is_station_referer')) ?>'>
                                    </div>
                                </div>
                            </div>
                            <div class='col-md-3 col-sm-6 col-xs-12 55b9fb22d536d87ffa157e5407447e5d' hidden>
                                <div class='item form-group'>
                                    <div class='col-xs-12'>
                                        <label class='text-muted checkbox-label'><?php echo (_('is_administrator')) ?></label>
...
<script src='<?php echo $_SERVER['PATH_WEBROOT'] ?>/js/contact.js<?= _VERSION_ ?>'></script>