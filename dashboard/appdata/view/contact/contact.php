                ...
                <div id='list' class='x_panel'>
                    ...
                    <div class='x_panel filter-container'>
                        ...
                        <div class='x_content filter-content' hidden>
                            ...
                            <div class='col-md-3 col-sm-6 col-xs-12 55b9fb22d536d87ffa157e5407447e5d'>
									<div class='form-group'>
										<div class='col-xs-12'>
								...
								<div class='col-md-3 col-sm-6 col-xs-12 1b2a31ade2f7767e2525797735a21b61'>
									<div class='form-group'>
										<div class='col-xs-12'>
                ...
                <form id='CompanyForm' method='POST' action='/service/person/save/<?php echo $Person->id; ?>' class='form-horizontal form-label-left' novalidate>
                    <div id='edit' class='x_panel'>
                        ...
                        <div class='x_content'>
                            ...
                            <div class='col-md-3 col-sm-6 col-xs-12 d5d3db1765287eef77d7927cc956f50a' hidden>
                                <div class='item form-group'>
                                    <div class='col-xs-12'>
                            ...
                            <div class='col-md-3 col-sm-6 col-xs-12 93c731f1c3a84ef05cd54d044c379eaa'>
                                <div class='item form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo ( _('company')) ?> </small>
                            ...
                            <div class='col-md-3 col-sm-6 col-xs-12 29f840186cf011c1b53858b4718cf213'>
                                <div class='item form-group'>
                                    <div class='col-xs-12'>
                                        <small class='text-muted'><?php echo ( _('job_title')) ?> </small>
                            ...
                            <div class='col-md-3 col-sm-6 col-xs-12 55b9fb22d536d87ffa157e5407447e5d'>
									<div class='item form-group'>
										<div class='col-xs-12'>
											...
											<input type = 'checkbox' onclick="$(this).val(this.checked ? 1 : 0)"  name='is_station_referer' class='col-md-1 col-xs-1 checkbox input-disabled' placeholder='<?php echo ( _('is_station_referer')) ?>' title='<?php echo ( _('is_station_referer')) ?>'>
										</div>
									</div>
								</div>
								<div class='col-md-3 col-sm-6 col-xs-12 1b2a31ade2f7767e2525797735a21b61'>
									<div class='item form-group'>
										<div class='col-xs-12'>
											...
											<input type = 'checkbox' onclick="$(this).val(this.checked ? 1 : 0)"  name='is_administrator' class='col-md-1 col-xs-1 checkbox input-disabled' placeholder='<?php echo ( _('is_administrator')) ?>' title='<?php echo ( _('is_administrator')) ?>'>
										</div>
									</div>
								</div>
                        </div>
