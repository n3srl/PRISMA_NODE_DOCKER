<?php /* @var $SystemConfiguration SystemConfiguration */ ?> 
<div class='right_col' role='main'>
	<div class=''>
		<div class='page-title'>
			<div class='title_left'>
				<h2><?= _('SystemConfiguration') ?></h2>
			</div>
		</div>
			<div class='clearfix'></div>
					...
					<div id='list' class='x_panel'>
						<div class='x_title no-padding-lr'>
							<div class='clearfix'>
								<div class='col-md-6 no-padding-l'>
									...
									<div class='col-md-6 no-padding'>
										<a href = '#edit' ><button type='button' onclick='newObj()' style='margin-right: 10px' class='btn btn-success pull-right' ><?= _('AGGIUNGI NUOVA CONFIGURAZIONE DI SISTEMA') ?></button></a>
									</div>
								</div>
							</div>
							...
							<div class='x_content filter-content' hidden>
								...
								<div class='form-group col-md-3 col-sm-6 col-xs-12 32d5567dd020a9a6c18cfd1ff4ffa293'>
									<div class='form-group'>
										<div class='col-xs-12'>
											<small class='text-muted'><?php echo (_('parameter_name')) ?></small>
											<select class='form-control filter filter-text' id='F_parameter_name' multiple='multiple' title='<?php echo (_('Filtra per parameter_name')) ?>'>
											</select>
										</div>
									</div>
								</div>
								<div class='form-group col-md-3 col-sm-6 col-xs-12 6eeb1ef82ef329ebc75ca15c570ef6e4'>
									<div class='form-group'>
										<div class='col-xs-12'>
											<small class='text-muted'><?php echo (_('parameter_value')) ?></small>
											<select class='form-control filter filter-text' id='F_parameter_value' multiple='multiple' title='<?php echo (_('Filtra per parameter_value')) ?>'>
											</select>
										</div>
									</div>
								</div>
							...
							<div class='x_content'>
								<table id='SystemConfigurationList' class='table table-striped table-bordered' style='width: 100%; '>
									<thead>
									<tr>
										<th><?php echo (_('oid')) ?></th>
										<th><?php echo (_('parameter_name')) ?></th>
										<th><?php echo (_('parameter_value')) ?></th>
										<th></th>
									</tr>
								</thead>
								<tbody>
				...
				<div class='col-md-12 col-sm-12 col-xs-12'>
					<form id='CompanyForm' method='POST' action='/service/systemConfiguration/save/<?php echo $SystemConfiguration->id;?>' class='form-horizontal form-label-left' novalidate>
						<div id='edit' class='x_panel'>
							...
							<div class='x_content'>
								...
								<div class='col-md-3 col-sm-6 col-xs-12 32d5567dd020a9a6c18cfd1ff4ffa293'>
									<div class='item form-group'>
										<div class='col-xs-12'>
											<small class='text-muted'><?php echo ( _('parameter_name')) ?> <span class='required'>*</span></small>
											<input type = 'text' name='parameter_name' required='required' class='form-control col-md-7 col-xs-12 input-disabled' placeholder=' <?php echo ( _('parameter_name')) ?> '  title=' <?php echo ( _('parameter_name')) ?>' maxlength = '100' />
										</div>
									</div>
								</div>
								<div class='col-md-3 col-sm-6 col-xs-12 6eeb1ef82ef329ebc75ca15c570ef6e4'>
									<div class='item form-group'>
										<div class='col-xs-12'>
											<small class='text-muted'><?php echo ( _('parameter_value')) ?> <span class='required'>*</span></small>
											<input type = 'text' name='parameter_value' required='required' class='form-control col-md-7 col-xs-12 input-disabled' placeholder=' <?php echo ( _('parameter_value')) ?> '  title=' <?php echo ( _('parameter_value')) ?>' maxlength = '100' />
										</div>
									</div>
								</div>
							</div>
	...
	<script src='<?php echo $_SERVER['PATH_WEBROOT'] ?>/js/systemConfiguration.js<?= _VERSION_ ?>'></script>
