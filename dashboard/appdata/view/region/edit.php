...
<div class='right_col' role='main'>
	<div class=''>
		<div class='page-title'>
			...
			<div class='clearfix'></div>
						...
						<div class='x_title no-padding-lr'>
							<div class='clearfix'>
								<div class='col-md-6 no-padding-l'>
									...
									<div class='col-md-6 no-padding'>
										<a href = '#edit' ><button type='button' onclick='newObj()' style='margin-right: 10px' class='btn btn-success pull-right' ><?= _('AGGIUNGI NUOVA REGIONE') ?></button></a>
									</div>
								</div>
							</div>
							...
							<div class='x_content filter-content' hidden>
								...
								<div class='form-group col-md-3 col-sm-6 col-xs-12 9ed39e2ea931586b6a985a6942ef573e'>
									<div class='form-group'>
										<div class='col-xs-12'>
											<small class='text-muted'><?php echo (_('state')) ?></small>
											<select class='form-control filter filter-text' id='F_state' multiple='multiple' title='<?php echo (_('Filtra per state')) ?>'>
											</select>
										</div>
									</div>
								</div>
							...
							<div class='x_content'>
								<table id='RegionList' class='table table-striped table-bordered' style='width: 100%; '>
									<thead>
									<tr>
				...
				<div class='col-md-12 col-sm-12 col-xs-12'>
					<form id='CompanyForm' method='POST' action='/service/region/save/<?php echo $Region->id;?>' class='form-horizontal form-label-left' novalidate>
						<div id='edit' class='x_panel'>
							...
							<div class='x_content'>
								...
								<div class='col-md-3 col-sm-6 col-xs-12 9ed39e2ea931586b6a985a6942ef573e'>
									<div class='item form-group'>
										<div class='col-xs-12'>
											<small class='text-muted'><?php echo ( _('state')) ?> <span class='required'>*</span></small>
											<input type = 'text' name='state' required='required' class='form-control col-md-7 col-xs-12 input-disabled' placeholder=' <?php echo ( _('state')) ?> '  title=' <?php echo ( _('state')) ?>' maxlength = '2' />
										</div>
									</div>
								</div>
								<div class='col-md-3 col-sm-6 col-xs-12 c13367945d5d4c91047b3b50234aa7ab'>
									<div class='item form-group'>
										<div class='col-xs-12'>
											...
											<input type = 'text' name='code' required='required' class='form-control col-md-7 col-xs-12 input-disabled' placeholder=' <?php echo ( _('code')) ?> '  title=' <?php echo ( _('code')) ?>' maxlength = '2' />
										</div>
									</div>
								</div>
								<div class='col-md-3 col-sm-6 col-xs-12 b068931cc450442b63f5b3d276ea4297'>
									<div class='item form-group'>
										<div class='col-xs-12'>
											<small class='text-muted'><?php echo ( _('name')) ?> <span class='required'>*</span></small>
											<input type = 'text' name='name' required='required' class='form-control col-md-7 col-xs-12 input-disabled' placeholder=' <?php echo ( _('name')) ?> '  title=' <?php echo ( _('name')) ?>' maxlength = '80' />
										</div>
									</div>
								</div>
							</div>
	...
	<script src='<?php echo $_SERVER['PATH_WEBROOT'] ?>/js/region.js<?= _VERSION_ ?>'></script>
