                            ...
                            <table id='DetectionList' class='table table-striped table-bordered noclick' style='width: 100%; '>
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo (_('Mese')) ?></th>
                                        <th><?php echo (_('Nr. report')) ?></th>
                                        <th style="text-align:center"><?php echo (_('Calibrazione predefinita')) ?></th>
                                        <th style="text-align:center"><?php echo (_('Download')) ?></th>
                                	</tr>
                                </thead>
                                <tbody>
                                </tbody>
...
<script src='<?php echo $_SERVER['PATH_WEBROOT'] ?>/js/monthlyCalibration.js<?= _VERSION_ ?>'></script>
