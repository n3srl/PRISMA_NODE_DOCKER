...
<div class='right_col' role='main'>
	<div class=''>
		<div class='page-title'>
			...
			<div class='clearfix'></div>
				<div class='row'>
					...
					<div id='list' class='x_panel'>
						<div class='x_title no-padding-lr'>
							...
							<div class='x_content'>
								<table id='EmailAlertList' class='table table-striped table-bordered' style='width: 100%; '>
									<thead>
									<tr>
				...
				<div class='col-md-12 col-sm-12 col-xs-12'>
					<form id='CompanyForm' method='POST' action='/service/emailAlert/save/<?php echo $EmailAlert->id;?>' class='form-horizontal form-label-left' novalidate>
	...
	<script src='<?php echo $_SERVER['PATH_WEBROOT'] ?>/js/emailAlert.js<?= _VERSION_ ?>'></script>
